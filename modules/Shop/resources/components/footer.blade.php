<footer aria-labelledby="footer-heading" class="bg-gray-900 text-gray-300 border-t border-gray-800 print:hidden">
  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div @class([
        'pt-20 pb-10 xl:grid xl:gap-8',
        'xl:grid-cols-3' => $shop_footer_settings['newsletter_input'] ?? false,
        'xl:grid-cols-2' => !($shop_footer_settings['newsletter_input'] ?? false),
    ])>
                ...
                @forelse ($section['menus'] as $menu)
                  <li class="text-sm">
                    <a href="{{ $menu['link'] }}"
                      ...
                      {{-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        class="size-3.5 opacity-0 group-hover:opacity-100 ms-0 group-hover:ms-2 transition-all ease-in duration-1000">
      ...
      @if ($shop_footer_settings['newsletter_input'] ?? false)
        @livewire('components.newsletter-subscribe-form')
      @endif
    </div>
      ...
      @if ($shop_footer_settings['social_links'] ?? [])
        <div class="flex gap-x-6 md:order-2">
          @if ($shop_footer_settings['social_links']['facebook'] ?? [])
            <a href="{{ $shop_footer_settings['social_links']['facebook'] }}" class="text-gray-400 hover:text-white">
          ...
          @endif
          @if ($shop_footer_settings['social_links']['instagram'] ?? [])
            <a href="{{ $shop_footer_settings['social_links']['instagram'] }}" class="text-gray-400 hover:text-white">
          ...
          @endif
          @if ($shop_footer_settings['social_links']['twitter'] ?? [])
            <a href="{{ $shop_footer_settings['social_links']['twitter'] }}" class="text-gray-400 hover:text-white">
          ...
          @endif
          @if ($shop_footer_settings['social_links']['github'] ?? [])
            <a href="{{ $shop_footer_settings['social_links']['github'] }}" class="text-gray-400 hover:text-white">
          ...
          @endif
          @if ($shop_footer_settings['social_links']['youtube'] ?? [])
            <a href="{{ $shop_footer_settings['social_links']['youtube'] }}" class="text-gray-400 hover:text-white">
          ...
          @endif
          @if ($shop_footer_settings['social_links']['pinterest'] ?? [])
            <a href="{{ $shop_footer_settings['social_links']['pinterest'] }}" class="text-gray-400 hover:text-white">
