<x-slot name="title">{{ __('Private Mode') }} - {{ shop_config('shop_name') }}</x-slot>
...
<div class="relative h-screen bg-gray-50 dark:bg-gray-800 overflow-hidden">
  ...
  <div class="relative h-screen flex items-center justify-center py-6 overflow-auto">
    <main class="mx-auto my-auto max-w-7xl px-4">
      <div class="text-center">
        <h1 class="flex items-center justify-center mb-12 text-2xl text-blue-600 font-extrabold">
        ...
        <h1 class="text-3xl tracking-tight font-extrabold text-gray-900 dark:text-gray-100 sm:text-4xl md:text-5xl">
          ...
          <span class="block text-blue-600 xl:inline">({{ __('Private Mode') }})</span>
        </h1>
        <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
          {{ __('Please login to access the shop.') }}
        </p>
