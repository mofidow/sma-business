<x-slot name="title">{{ __('Private Mode') }} - {{ $shop_settings['name'] }}</x-slot>
  ...
  <div class="relative h-screen flex items-center justify-center py-6 overflow-auto">
    <main class="mx-auto my-auto max-w-7xl px-4">
      <div class="text-center">
        <h1 class="flex items-center justify-center mb-6 text-2xl text-blue-600 font-extrabold">
        ...
        <div class="text-3xl tracking-tight font-extrabold text-gray-900 dark:text-gray-100 sm:text-4xl md:text-5xl">
          ...
          <div class="mt-2 text-blue-600">({{ __('Private Mode') }})</div>
        </div>
