...
<template>
  <div :class="size ? size : 'size-5'">
    ...
    <svg v-else-if="name == 'sick'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-full w-full" viewBox="0 0 256 256">
      <path
    ...
    <svg v-else-if="name == 'refresh'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-full w-full">
      <path
        fill-rule="evenodd"
