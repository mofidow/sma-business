  ...
  let menus = [
    {
      ...
      menus: [
        ...
        },
        {
          name: 'hr',
          route: null,
          route_prefix: '/admin/hr',
          icon: 'users',
          label: t('HR & Payroll'),
          permissions: ['read-employees', 'read-leaves', 'read-attendances', 'read-payrolls', 'read-claims', 'settings'],
          sub_menu: [
            {
        ...
        },
        {
          ...
          sub_menu: [
            ...
            },
            {
              ...
              icon: 'tipjar',
              target: 'reports',
              permissions: ['income-report'],
              label: t('{x} Report', { x: t('Income') }),
            },
            {
            ...
            {
              name: 'inventory_accounting.report',
              route: 'inventory_accounting.report',
              icon: 'list',
              target: 'reports',
              permissions: ['inventory_accounting-report'],
              label: t('{x} Report', { x: t('Inventory Accounting') }),
            },
            {
              name: 'credits.report',
              route: 'credits.report',
              icon: 'dollar',
              target: 'reports',
              permissions: ['read-sales'],
              label: t('{x} Report', { x: t('Credit (Deyn)') }),
            },
            {
